...
export const NavLink: React.FC<NavLinkProps & { variant: 'desktop' | 'mobile' }> = ({
  ...
  return (
    <a
      href={path}
      className={clsx('font-medium text-base', isCurrent ? 'border-blue-500' : 'border-transparent text-gray-500', {
        ['inline-flex items-center px-1 pt-1 border-b-2 hover:border-gray-300']: variant === 'desktop',
        ...
        ['bg-blue-100 text-blue-700 hover:border-blue-500 hover:text-blue-700']: variant === 'mobile' && isCurrent,
      })}
    >
      {name}
    </a>
